...
#<!--title: "Raspberry Pi Installation of Ledfx & Spotifyd"-->
...
This setup was tested on 2023-11-10 on a Raspberry Pi 4 with Raspberry Pi OS Lite 2023-10-10 (Debian 12 Bookworm). 
...
4. Logout from SSH session and login to `ledfx` account over ssh (See [Failed to initialize DBus connection Error Below](#Error: Failed to initialize DBus connection)
...
* [raw githubusercontent: spotifyd.service](https://raw.githubusercontent.com/Spotifyd/spotifyd/master/contrib/spotifyd.service)
```sh
...
```
* See [[#Pulseaudio issues]] below if you have issues
...
##### 7. Set up LEDFx as systemd daemon and finishing touches
